...
const Services = () => {
  return (
    <div className="p-16 max-[640px]:flex flex-col  grid  grid-cols-3">





      <div className=" max-[640px]:w-11/12 relative  flex flex-col mt-6 text-gray-700 bg-white shadow-md bg-clip-border rounded-xl w-96">
