      ...
      <div>
        <div className="max-[640px]:flex flex-col grid grid-cols-2">
          <div className="grid grid-rows-2">
            ...
            <div className="">
              <h3 className="font-serif p-2 text-5xl text-red-700">
                Auction App
              </h3>
              <h3 className="text-3xl">
                <span className="font-bold"></span>{" "}
                <span className="">React,MongoDb,Node js,Express</span>
              </h3>
              <h3 className="text-2xl pt-2 font-mono  hover:underline">
                <Link href="https://www.linkedin.com/feed/update/urn:li:activity:7231617064312913920/">
                  <span className="font-bold text-slate-800">Linkedin</span>{" "}
                </Link>
              </h3>
              <h3 className="text-2xl pt-1 font-mono  hover:underline">
                <Link href="https://www.auctionarena.live/">
          ...
          <Link href=" ">
            ...
            <div>
              {" "}
              <Image
                className="hover:opacity-10 h-9/12  w-9/12"
                src={project8}
                style={{
                  padding: "20px",
                  borderRadius: "10%",
        ...
        <div className="max-[640px]:flex flex-col grid grid-cols-2">
          <div className="grid grid-rows-2">
            ...
            <div className="">
              ...
              <h3 className="text-2xl pt-2 font-mono  hover:underline">
                <Link href="https://github.com/SUPHAL-MAITY/Food-App">
          ...
          <Link href="https://youtube.com/shorts/VaHXI9v23Fo?feature=share">
            {" "}
            <div>
              {" "}
              <Image
      ...
      <div className="max-[640px]:flex flex-col grid grid-cols-2">
        <div className=" grid grid-rows-2">
          ...
          <div className="">
            ...
            <h3 className="text-2xl pt-2 font-mono  hover:underline">
              <Link href="https://github.com/SUPHAL-MAITY/ecommerce-mern-stack-project">
                <span className="font-bold text-slate-800">GitHub </span>{" "}
              </Link>
            </h3>
            <h3 className="text-2xl pt-1 font-mono  hover:underline">
        ...
        <Link href="https://youtu.be/DcpZBN9kn_c">
          {" "}
          <div>
            {" "}
            <Image
      ...
      <div className="max-[640px]:flex flex-col grid grid-cols-2">
        <div className="  grid grid-rows-2">
          ...
          <div className="">
            ...
            <h3 className="text-3xl">
              <span className="font-bold"></span>{" "}
              <span className="">React,News Api</span>
            </h3>
            <h3 className="text-2xl pt-2 font-mono  hover:underline">
              <Link href="https://github.com/SUPHAL-MAITY/NewsApp_2024">
                <span className="font-bold text-slate-800">GitHub </span>{" "}
              </Link>
            </h3>
            <h3 className="text-2xl pt-1 font-mono  hover:underline">
      ...
      <div className="max-[640px]:flex flex-col grid grid-cols-2">
        <div className=" grid grid-rows-2">
          ...
          <div className="">
            ...
            <h3 className="text-2xl pt-2 font-mono  hover:underline">
              <Link href="https://github.com/SUPHAL-MAITY/Landing_gym_website">
                <span className="font-bold text-slate-800">GitHub </span>{" "}
              </Link>
            </h3>
            <h3 className="text-2xl pt-1 font-mono  hover:underline">
      ...
      <div className="max-[640px]:flex flex-col grid grid-cols-2">
        <div className="  grid grid-rows-2">
          ...
          <div className="">
            ...
            <h3 className="text-2xl pt-2 font-mono  hover:underline">
              <Link href="https://github.com/SUPHAL-MAITY/Landing-Page-of-food-delivery-website">
                <span className="font-bold text-slate-800">GitHub </span>{" "}
              </Link>
            </h3>
            <h3 className="text-2xl pt-1 font-mono  hover:underline">
      ...
      <div className="max-[640px]:flex flex-col grid grid-cols-2">
        <div className=" grid grid-rows-2">
          ...
          <div className="">
            ...
            <h3 className="text-3xl">
              <span className="font-bold"></span> HTML,CSS,JS{" "}
              <span className=""></span>
            </h3>
            <h3 className="text-2xl pt-2 font-mono  hover:underline">
              <Link href="https://github.com/SUPHAL-MAITY/Expense-Tracker">
                <span className="font-bold text-slate-800">GitHub </span>{" "}
              </Link>
            </h3>
            <h3 className="text-2xl pt-1 font-mono  hover:underline">
      ...
      <div className=" max-[640px]:flex flex-col h-full grid grid-cols-2">
        <div className=" grid grid-rows-2">
          ...
          <div className="">
            ...
            <h3 className="text-2xl pt-2 font-mono  hover:underline">
              <Link href="https://github.com/SUPHAL-MAITY/Landing-page">
                <span className="font-bold text-slate-800">GitHub </span>{" "}
              </Link>
            </h3>
            <h3 className="text-2xl pt-1 font-mono  hover:underline">
